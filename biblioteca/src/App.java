...
// // menu para indicar o tipo de usuário que será cadastrado, retorna o tipo
// int
...
// public static void visualizarEmprestimo(Scanner teclado, LinkedList<Usuarios>
// usuarios,
...
// dataPrevistaDevolucaoAuxiliar =
// emprestimoItem.getDataPrevistaDevolucao().dataFormatada();

// System.out.println("Data do Emprestimo: " +
// emprestimoItem.getDataEmprestimo().dataFormatada() + " | "
// + "Data Prevista Devolução: " + dataPrevistaDevolucaoAuxiliar + " | " + "Data
// do Devolução: "
...
// public static void visualizarAlunosSuspensos(Scanner teclado,
// LinkedList<Usuarios> usuarios) {
// for (Usuarios usuario : usuarios) {
// if (usuario.getDiasSuspensao() > 0) {
// System.out.println(
// "Usuario: " + usuario.ToString() + " - suspenso: " +
// usuario.getDiasSuspensao() + " dias");
// }
// }
// System.out.println("-----------------------------------------------------------");
// System.out.println("Pressione enter para volta para o menu");
...
// public static void visualizarLivrosAtrasados(Scanner teclado,
// LinkedList<Emprestimo> emprestimos) {
// for (Emprestimo emprestimo : emprestimos) {
// if (emprestimo.hashCode() > 0) {
// System.out.println(
// "Usuario: " + emprestimo.ToString() + " - suspenso: " + emprestimo + "
// dias");
// }
// }
// System.out.println("-----------------------------------------------------------");
...
// && livroFisico.getClass().getSimpleName() ==
// (mock.getClass().getSimpleName())) {
// livroMaisEmprestado = livroFisico;
// } else if (livroFisico.getClass().getSimpleName() ==
// mock.getClass().getSimpleName()
// && ((LivrosFisicos) livroFisico).getEmprestimos() > ((LivrosFisicos)
// livroMaisEmprestado)
// .getEmprestimos()) {
// livroMaisEmprestado = livroFisico;
// }
...
// && livroDigital.getClass().getSimpleName() ==
// (mock.getClass().getSimpleName())) {
// livroMaisVisualizado = livroDigital;
// } else if (livroDigital.getClass().getSimpleName() ==
// (mock.getClass().getSimpleName())
// && ((LivrosDigitais) livroDigital).getVisualizacao() > ((LivrosDigitais)
// livroMaisVisualizado)
// .getVisualizacao()) {
// livroMaisVisualizado = livroDigital;
// }
// }
...
// // Opção 3 - Método para realização de empréstimos, ele chama o método da
// classe
// // Usuarios e cadastra um emprestimo na lista dele.
// public static void cadastrarEmprestimo(Scanner teclado, LinkedList<Usuarios>
// usuarios,
